          ...
          <div className="modal-body" style={{ maxHeight: '400px', overflowY: 'auto' }}>
            {tipoDocumento === 'Título' && (
              <div className="alert alert-warning d-flex gap-2 mx-2" role="alert">
                ...
                <div>Para este documento necesitarás adjuntar <strong>formato de certificación de estudios, recibo de pago, constancia de no adeudo y carta liberacion de estadías.</strong></div>
              </div>
            )}
